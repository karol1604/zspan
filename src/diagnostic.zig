...
pub const Label = struct {
    ...
    fileId: usize, // This is the index of the file in the SourceFiles array
    ...
    pub fn primary(fileId: usize, file: *const SourceFile, start: usize, end: usize) Label {
        return .{
            .fileId = fileId,
            .style = .Primary,
            .file = file,
    ...
    pub fn secondary(fileId: usize, file: *const SourceFile, start: usize, end: usize) Label {
        return .{
            .fileId = fileId,
            .style = .Secondary,
            .file = file,
